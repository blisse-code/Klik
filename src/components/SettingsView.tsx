...
const KIND_BADGE: Record<string, string> = {
  foundation: 'text-blue-300 border-blue-500/40 bg-blue-500/10',
  'open-source': 'text-emerald-300 border-emerald-500/40 bg-emerald-500/10',
  local: 'text-amber-300 border-amber-500/40 bg-amber-500/10',
};
          ...
          <form onSubmit={save} className="space-y-5">
            <div>
              <div className="flex items-baseline justify-between mb-2">
                ...
                <span className="text-[9px] text-white/30">Tried top → bottom</span>
              </div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex flex-col gap-0.5">
                          <button
                            ...
                            disabled={index === 0}
                            className="w-6 h-5 rounded bg-white/5 hover:bg-white/10 flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed"
                            aria-label="Move up"
                          >
                        ...
                        <span className="text-[9px] text-white/30 font-mono">#{index + 1}</span>
                      </div>
                        ...
                        <div>
                          <div className="relative">
                            <input
                              ...
                              className="w-full px-3 py-2 pr-10 bg-black/60 border border-white/10 rounded-md text-xs font-mono placeholder-white/30 focus:outline-none focus:border-blue-500"
                              autoComplete="off"
                            />
                            <button
                              type="button"
